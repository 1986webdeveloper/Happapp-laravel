...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('voyager::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' Video' }}
    </h1>
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                ...
                                <!-- <i class="voyager-character"></i> --> Video Title
                                <!-- <span class="panel-desc"> {{ __('voyager::post.title_sub') }}</span> -->
                                <span class="panel-desc"> The title for your video </span>
                            </h3>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Video Content</h3>
                            <div class="panel-actions">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Extra Section</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                            <!--  @if(isset($dataTypeContent->post_video))
                            <?php
                                $video = 'uploads/'.$dataTypeContent->post_video;
                            ?>
                            <video width="300" height="200" controls>
                                <source src="<?php echo asset($video); ?>" type="video/mp4">
                            </video> 
                            @endif
                            <input accept="video/mp4" type="file" name="post_video"> -->
                        </div>
                        <div class="panel-body">
                            @php
                                $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'category_id', 'author_id', 'featured', 'image','post_video', 'meta_description', 'meta_keywords', 'seo_title'];
                            @endphp
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> Video Details</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <label for="status">Video Category</label>
                   ...
                   <!--  <div class="panel panel-bordered panel-primary">
                    ...
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-image"></i>Video</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            @if(isset($dataTypeContent->post_video))
                            <?php
                                $video = 'uploads/videos/'.$dataTypeContent->post_video;
                            ?>
                            <video width="300" height="200" controls>
                                <source src="<?php echo asset($video); ?>" type="video/mp4">
                            </video> 
