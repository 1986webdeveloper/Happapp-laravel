...
<?php
include('jwplayer/jwplayer.php');
?>
<link href="https://vjs.zencdn.net/7.5.4/video-js.css" rel="stylesheet">

  <!-- If you'd like to support IE8 (for Video.js versions prior to v7) -->
  <script src="https://vjs.zencdn.net/ie8/1.1.2/videojs-ie8.min.js"></script>
<script type=”text/javascript” src="https://cdn.jwplayer.com/players/UVQWMA4o-kGWxh33Q.js"></script>
...
@section('content')
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Video Section</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
 ...
 <video id='my-video' class='video-js' controls preload='auto' width='640' height='264'
  poster='MY_VIDEO_POSTER.jpg' data-setup='{}'>
    <source src="<?php echo asset($video); ?>" type='video/3gp'>
    <source src="<?php echo asset($video); ?>" type='video/webm'>
    <p class='vjs-no-js'>
      ...
      <a href='https://videojs.com/html5-video-support/' target='_blank'>supports HTML5 video</a>
                            ...
                            <?php
                                $video = 'uploads/'.$dataTypeContent->post_video;
                                jwplayer::play(array(array('file' => ''.asset($video).'', 'title' => 'Most awesome video ever'), ));
                                ?>
                            @endif
